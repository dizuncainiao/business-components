...
const token = 'eyJhbGciOiJIUzUxMiJ9.eyJqdGkiOiJiZHNhYXMiLCJzdWIiOiI0MjM0NSIsImV4cCI6MTY5MTA3NTUwN30.sAc3xlRNZswc64yrgutvF2lA6AOHcVTrF2RW8wG-GSnTCTkOaBI1Ct2zNjUrHMvr6mXvQ20S58Ercb7VpVaj0g'

const downloadAction = `${window === window.parent ? window.origin : window.parent.origin}/bdsaas/ajax/crm/downloadCustomerExcel.do`
